...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {        let mut map = HashMap::new();        map.insert("password".to_string(), "Zyp@ssw0rd".to_string());        RwLock::new(map)    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["homedc.cn"];
pub const RS_PUB_KEY: &str = "zyp@ssw0rd";
